...
df=m-nve;
past=.99;%
 pValue=1-chi2cdf(J,df)%>0.01 not suspicious bad data for a confidence level of 1% or p*=.99
                         %>0.99 not suspicious bad data for a confidencelevel of 99% or p*=1%
 J-chi2inv(1-past,df) %<0 not suspicious bad data for a confidence level of 1-p*
...
%Retiramos el TC9, medidas 17 y 25 (quitar comentarios)
